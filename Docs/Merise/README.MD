...
13. OAuthAccount
(id_oauth: UUID PK, provider: ENUM('GOOGLE', 'GITHUB', 'FACEBOOK'), provider_user_id: VARCHAR(255), access_token: TEXT NULL, refresh_token: TEXT NULL, created_at: TIMESTAMP, user_id: UUID FK → User)
